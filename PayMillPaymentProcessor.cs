...
namespace Nop.Plugin.Payments.PayMill
{
    ...
    public class PayMillPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public PayMillPaymentProcessor(PayMillPaymentSettings PayMillPaymentSettings,
            ISettingService settingService, PaymentPayMillController PayMillController, IOrderService OrderService, ICustomerService CustomerService, ILogger logger, ICurrencyService CurrencyService, CurrencySettings CurrencySettings, IOrderTotalCalculationService orderTotalCalculationService)
        {
        ...
        public PaymentModel getPayment(string urlvalues)
        {
            ...
            try
            {
                ...
                _logger.InsertLog(Core.Domain.Logging.LogLevel.Error, response, response, null);
        ...
        public string GetPMAPIResponse(string url, string uid)
        {
            ...
            { 
                ...
                SetBasicAuthHeader(webRequest, uid, "");
        ...
        {
            decimal fee = _PayMillPaymentSettings.AdditionalFee;
            decimal? cartotal = _orderTotalCalculationService.GetShoppingCartTotal(cart, usePaymentMethodAdditionalFee: false);
            var result = this.CalculateAdditionalFee(_orderTotalCalculationService, cart,
                fee, _PayMillPaymentSettings.AdditionalFeePercentage);
            return result;
        }
        ...
        public override void Install()
        {
            ...
            //locales
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayMill.Fields.Explain", "Please note that putting any value into the \"Range 1\" field will override any value that is placed into the \"Additional Fee\" field. Ranges should be input as semicolon \";\" seperated values. For instance if you want to create a fee of 3 dollars of all purchases between 1 and 100 dollars you would put \"0;100;3\". ");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayMill.Fields.AdditionalFee", "Additional fee");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayMill.Fields.AdditionalFee.Hint", "Enter additional fee to charge your customers.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Paymill.Fields.AdditionalFeePercentage", "Additional fee. Use percentage");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayMill.Fields.AdditionalFeePercentage.Hint", "Determines whether to apply a percentage additional fee to the order total. If not enabled, a fixed value is used.");
        ...
        {
            //locales
            this.DeletePluginLocaleResource("Plugins.Payments.PayMill.Fields.Explain");
            this.DeletePluginLocaleResource("Plugins.Payments.PayMill.Fields.AdditionalFee");
            this.DeletePluginLocaleResource("Plugins.Payments.PayMill.Fields.AdditionalFee.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.Paymill.Fields.AdditionalFeePercentage");
            this.DeletePluginLocaleResource("Plugins.Payments.PayMill.Fields.AdditionalFeePercentage.Hint");
